# SovTech Javascript Style Guide

Based off the AirBnB javascript style guide: _A mostly reasonable approach to JavaScript_

Note that at SovTech we use Typescript over Javascript where possible but this code style guide applies to both. Typescript specific styles can be found in the [Typescript](../typescript) section
